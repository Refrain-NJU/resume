...
共有5,155个注册人员，其中1209份申请被Google接纳\textbf{(中选率仅23\%)}.ColumnStore是基于MariaDB构建的分布式列式存储引擎，它为MariaDB提供了快速的大规模数据分析能力.
\begin{itemize}[parsep=0.3ex]
  \item \textbf{个人工作:}设计实现了SELECT子句中的JSON函数，补全缺失的JSON函数部分;
