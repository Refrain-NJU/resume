...
\datedsubsection{\underline{\textbf{\href{https://summerofcode.withgoogle.com/programs/2022/projects/VIJfR79a}{MariaDB - Google开源之夏}}}\quad C++ / SQL / JSON}{2022.6 -- 2022.9}
...
\begin{itemize}[parsep=0.3ex]
  \item \textbf{个人贡献:}设计并实现了\verb|SELECT|子句中的JSON函数, 实现了MariaDB的JSON函数下推;
  ...
  \item \textbf{最终成果:} 8600+代码成功\textbf{合并到代码主分支}, 最终在Release 22.08.2发布;\enspace\githubicon{https://github.com/mariadb-corporation/mariadb-columnstore-engine/pull/2425}
  \item 提交合并了3个JSON相关补丁, 确保用户在10.3\textasciitilde 10.9版本的兼容性和性能改进:
        \begin{itemize}
        ...
        \end{itemize}
\end{itemize}
\datedsubsection{\underline{\textbf{\href{https://summer-ospp.ac.cn\#/org/orgdetail/1bf2ea9b-fdf1-45a5-bbb1-d81827445986/}{JuiceFS - 中科院开源之夏}}}\quad Go / Concurrency / File System}{2022.7 -- 2022.10}
...
\end{itemize}
\datedsubsection{\underline{\textbf{\href{https://github.com/opencurve/curve}{Curve - 云原生计算基金会}}}\quad C++ / Concurrency / File System}{2023.2 -- 至今}
