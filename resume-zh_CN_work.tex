...
\textit{工学硕士}\ 计算机系统结构 \enspace \textit{学业一等奖学金、腾讯奖学金、华为软挑二等奖(获奖率6.6\%)}
...
\begin{itemize}[parsep=0.2ex]
  ...
  \item MNS集群限流于9.5日成功\textbf{上线广州Region}, 运行状况良好, 已计划陆续上线其他Region;
  \item 负责中间件内核升级的性能回归, 针对海量Topic场景提出\textbf{元数据检索, 批量路由注册}等改进. \githubicon{https://github.com/apache/rocketmq/pull/7276}\githubicon{https://github.com/apache/rocketmq/pull/7325}
\end{itemize}
...
\textbf{其他开源经历:}
\begin{itemize}
  \item Curve - 分布式存储 / 网易杭州研究院 \githubicon{https://github.com/opencurve/curve/commits/master?author=Ziy1-Tan}、GraphAr - 图计算 / 阿里巴巴达摩院 \githubicon{https://github.com/alibaba/GraphAr/commits/main?author=Ziy1-Tan}
\end{itemize}
...
\datedline{中国开源创新大赛二等奖}{2023年}
\datedline{华中科技大学知行奖学金}{2023年}
\datedline{华中科技大学社会活动积极分子}{2022 / 2023年}
\datedline{华中科技大学学业二等奖学金}{2022 / 2023年}
\datedline{华中科技大学社会实践优秀个人}{2022年}
\end{document}
